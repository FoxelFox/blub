...
class Grid {
    ...
    constructor(width: number, height: number, pathTexture: string) {
        this.width = width;
        this.height = height;
        this.createBorders();
        ...
        var gridTex = new THREE.TextureLoader().load('img/grid.png', null);
        gridTex.wrapS = THREE.RepeatWrapping;
        gridTex.wrapT = THREE.RepeatWrapping;
        gridTex.repeat.set(this.width, this.height);
    ...
    private createBorders() {
        ...
        this.body.addShape(new p2.Plane(), [0, this.height / 2], Math.PI); // Top
        this.body.addShape(new p2.Plane(), [0, -this.height / 2], 0); // Bottom
        this.body.addShape(new p2.Plane(), [this.width / 2, 0], Math.PI / 2); // Right
        this.body.addShape(new p2.Plane(), [-this.width / 2, 0], -Math.PI / 2); // Left
    }
}
...
function GameObject(pGameObject) {
    ...
    var body = new p2.Body({
        ...
        // damping: 0.99 // TODO: WTF?! this isnt even a valid field of options!
    });
